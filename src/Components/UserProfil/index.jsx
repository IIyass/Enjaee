    ...
    return (
        <>
            ...
            <Style.Wrapper>
                <Style.Hero>
                    {
                        userProfil.avatar ? <img alt="Bitmap" src={userProfil.avatar} /> :
            ...
            <Style.ButtonContainer>
                {me.blockedUsers.includes(userProfil.id) ? <ProfilButton onClick={() => unBlockContact(userProfil.id)} >UnBlock</ProfilButton> :
                    <ProfilButton onClick={() => blockContact(userProfil.id)} >Block</ProfilButton>}
