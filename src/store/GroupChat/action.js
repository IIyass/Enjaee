import { ADD_GROUP_ACTION, BACK_TO_CONTACT, GET_TEAM_BY_ID, SELECT_GROUP_PERSON, REMOVE_GROUP_PERSON, ADD_GROUP_BY_NAME } from './actionType'
...
export const getTeamById = () => async (dispatch, getState) => {
    ...
    const TeamInfo = MockData.filter(({ id }) => {
        return GroupPersonState.includes(id)
    })
